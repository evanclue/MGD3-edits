...
return Def.ActorFrame {
	LoadActor( "../../shared_main" )..{
		OnCommand=function(self) self:rainbow():diffusealpha(1):linear(2):diffusealpha(0) end
	},
	Def.Sprite{
		...
		OnCommand=function(self) self:zoom(3):decelerate(2):scale_or_crop_background() end
	},
	Def.Quad{
